...
| 51 | pattern_section             | Index of different flight sections within the reel-out phase: 0 = right turn/1 = right to left straight section/2 = left turn/3 = left to right straight section/-1 = other | -                |
